...
#+BEGIN_SRC emacs-lisp
  (setq user-full-name "Bassim Shahidy"
    user-mail-address "bassim101@gmail.com")
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  ...
  ;; Set path for darwin
  (when (system-is-mac)
    (setenv "PATH" (concat (getenv "PATH") ":/Users/bassim-nix/.nix-profile/bin:/usr/bin"))
    (setq exec-path (append '("/Users/bassim-nix/bin" "/profile/bin" "/Users/bassim-nix/.npm-packages/bin" "/Users/bassim-nix/.nix-profile/bin" "/nix/var/nix/profiles/default/bin" "/usr/local/bin" "/usr/bin") exec-path)))
#+END_SRC
