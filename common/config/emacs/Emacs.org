...
#+BEGIN_SRC emacs-lisp
  ...
  (defun dl/set-window-padding ()
    ...
    (set-face-attribute 'header-line nil :height 1.5)
    (set-face-background 'header-line default-background))

  (add-hook 'text-mode-hook 'dl/set-window-padding)
  (add-hook 'prog-mode-hook 'dl/set-window-padding)
#+END_SRC
