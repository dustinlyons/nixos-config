...
;;(defun dl/move-todo-and-transclude ()
;;  "Move Todo heading in current buffer to Todo file and add transclude link"
;;       (interactive)
;;       (org-refile...
...
(defun dl/insert-current-time ()
 ...
 (dl/leader-keys
  ...
  ","  '(dl/move-todo-and-transclude :which-key "transclude"))
...
#+BEGIN_SRC emacs-lisp
  ...
  (setq org-tag-persistent-alist
    '(("@Home" . ?h) ("@Errands" . ?e) ("@Office" . ?o) ("@Phone" . ?p)))
  ...
  (setq org-tag-faces
    `(("@Home" . ,dl/green-color)
     ("@Errands" . ,dl/purple-color)
     ("@Office" . ,dl/teal-color)
     ("@Phone" . ,dl/purple-color)
     ("Inbox" . ,dl/blue-color)))
#+END_SRC
