...
This configuration drives how I interact with my journal, complete and organize tasks, develop and write blog posts, and write code. Other stuff too. If I can do it in Emacs, I generally do. 
