#+TITLE: Emacs
#+STARTUP: content
#+CONSTANTS: code_dir_path="/mnt/state/Projects/Code"
...
#+BEGIN_SRC emacs-lisp
  ...
  (when (system-is-linux)
    (set-face-attribute 'variable-pitch nil :font "Helvetica LT Std" :height 120))
...
Show symbols in the gutter to reflect status of git hunks. This + magit make Emacs the best git experience, hands down.
#+BEGIN_SRC emacs-lisp
  (use-package git-gutter-fringe+)
  (global-git-gutter-mode 1) ;; Show git changes everywhere
#+END_SRC
** Global Settings
...
#+BEGIN_SRC emacs-lisp
    ...
    (use-package evil-org
      ...
      :config
        ...
        ;; Added Nov 8, 2021 to resolve bug related to
        ;; removal of evil-redirect-digit-argument
