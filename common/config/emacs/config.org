...
#+BEGIN_SRC emacs-lisp
(defvar original-font-size (face-attribute 'default :height))
(defvar writing-font-size 150) ; Adjust as needed

(defun enter-writing-mode ()
  (load-theme 'doom-one-light t)
  (set-face-attribute 'default nil :height writing-font-size)
...
(use-package writeroom-mode
  :ensure t
  :config
  (setq writeroom-width 100)       ; adjust the width as needed
