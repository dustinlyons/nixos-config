...
# Nix for MacOS + NixOS
[![Build Starter Template](https://github.com/dustinlyons/nixos-config/actions/workflows/test-nix-flake.yml/badge.svg)](https://github.com/dustinlyons/nixos-config/actions/workflows/test-nix-flake.yml)
