...
This is a Nix configuration that works across MacOS and NixOS. You can find shared configuration in `common`. This is also a good example of a MacOS Nix Flake.
